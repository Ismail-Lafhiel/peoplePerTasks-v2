...
<body class="dark:bg-gray-900">
        ...
        <div class="grid max-w-screen-xl mt-10 px-4 py-8  mx-auto lg:gap-0 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mx-auto lg:mx-auto place-self-center lg:col-span-7 w-auto">
                ...
                <a href="../src/marketplace.php"
                    class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-3xl bg-blue-600 hover:bg-blue-700 focus:ring-4">
                    <?= __("Hire Freelancers") ?>
            ...
            <div class="grid gap-6 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-center">
                <div class="w-64 bg-white p-8 rounded-lg dark:bg-gray-800 shadow-md">
                    <div
                        ...
                        <svg width="40" height="42" viewBox="0 0 37 39" fill="none" xmlns="http://www.w3.org/2000/svg"
                            class="text-[#00373E] dark:text-white">
                            <path
                                d="M23.3543 23.5229L36.3887 0.6875H27.6543L14.5863 23.5145C14.57 23.5346 14.561 23.5598 14.561 23.5858C14.561 23.6118 14.57 23.637 14.5863 23.6572L22.8924 38.2537C22.926 38.3125 22.9596 38.3125 23.0268 38.3125H31.6855L23.3459 23.6404C23.3391 23.6213 23.3363 23.601 23.3377 23.5808C23.3392 23.5605 23.3448 23.5408 23.3543 23.5229ZM15.6361 16.1574L10.6895 7.49023C10.673 7.4611 10.6482 7.43754 10.6183 7.42257C10.5884 7.40761 10.5547 7.40193 10.5215 7.40625H2.45898L7.40566 16.1742C7.41663 16.1948 7.41962 16.2187 7.41406 16.2414L0.611328 27.5625H8.74102C8.76856 27.566 8.7965 27.5605 8.8207 27.5469C8.8449 27.5333 8.86407 27.5123 8.87539 27.4869L15.6361 16.2582C15.6445 16.2251 15.6445 16.1905 15.6361 16.1574Z"
                                fill="currentcolor" />
                        </svg>
                    ...
                    <button type="button"
                        class="text-blue-600 hover:text-black dark:hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-xl mt-5 px-6 dark:focus:ring-blue-600 ">
                        <?= __("APPLY NOW") ?>
                    </button>
                </div>
                <div class="w-64 bg-white p-8 rounded-lg dark:bg-gray-800 shadow-md">
                        ...
                        <svg width="40" height="40" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <defs>
                                <filter id="filter0_d_1_148" x="0" y="0" width="51" height="51"
                                    ...
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1_148"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
                    ...
                    <button type="button"
                        class="text-blue-600 hover:text-black dark:hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-xl mt-5 dark:focus:ring-blue-600 px-6">
                        <?= __("APPLY NOW") ?>
                    </button>
                </div>
                <div class="w-64 bg-white p-8 rounded-lg dark:bg-gray-800 shadow-md">
                    ...
                    <button type="button"
                        class="text-blue-600 hover:text-black dark:hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-xl px-6 dark:focus:ring-blue-600 mt-5">
                        <?= __("APPLY NOW") ?>
                    </button>
                </div>
            </div>
    ...
    <section class="categories">
        <div class=" flex flex-col items-center py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="grid gap-6 lg:gap-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 items-center">
                ...
                <div class="shadow-md">
                    <a href="../src/marketplace.php" class="block w-full h-50 relative rounded-2xl overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                        <div class="absolute inset-0 flex items-center justify-center">
                            <span class="text-white text-xl tracking-wider font-bold">
                                <?= __("Video Editing") ?>
                            </span>
                        </div>
                    </a>
            ...
            <button id="More" type="button"
                class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-3xl text-xl px-5 py-3 text-center ml-1 md:ml-1 mt-10 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                <?= __("More categories") ?>
            </button>
        </div>
    </section>
    <section class=" freelancers">
        <div class="flex flex-col items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <h2
                class="mb-12 text-2xl tracking-tight font-normal text-[#00373E] dark:text-white lg:text-5xl text-center">
                <?php if (isset($_GET['lang']) == "fr") { ?>
                    <span class="text-blue-600">
                        <?= __("freelancers") ?>
                    </span>
            ...
            <div class="grid gap-6 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-center">
                ...
                <div
                    class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="../images/freelancer3.jpg"
                        alt="Yassine Louissi">
                    <h3 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                ...
                <div
                    class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="../images/freelancer1.jpg"
                        alt="Abdeljabbar Ait">
                    <h3 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="../src/freelancers.php">Abdeljabar
                        </a>
    ...
    <section class="Testimonials">
        <div
            class=" flex flex-col justify-evenly sm:flex-row lg:flex-row items-center py-8 px-8 mx-auto max-w-screen-xl lg:px-6 lg:py-16">
            <div class="text-left w-96 ">
                ...
                <div class="hidden lg:mt-8 lg:flex lg:gap-4">
                    ...
                    <button aria-label="Next slide" id="next"
                        class="rounded-full border border-black p-3 text-black transition dark:border-white dark:text-white hover:bg-[#00373E] hover:text-white">
            ...
            <div class="-mx-6 lg:col-span-2 lg:mx-0 self-center justify-start overflow-hidden mt-4 shadow-md"
                id="client">
                <div id="clients_slider" class="w-[410px] flex gap-4 px-2 duration-200">
                        ...
                        <div
                            ...
                            <div>
                                <div class="flex items-center ">
                                    <img src="../images/client1.jpg" alt="Aymane Benhima"
                                        class="mb-4 rounded-full w-11 h-11">
                    ...
                    <div class="client">
                        <div
                            ...
                            <div>
                                <div class="flex items-center ">
                                    <img src="../images/client2.jpg" alt="Aymane Benhima"
                                        class="mb-4 rounded-full w-11 h-11">
                                    <div class="flex flex-col mb-4 ml-8">
                    ...
                    <div class="client">
                        <div
                            ...
                            <div>
                                <div class="flex items-center ">
                                    <img src="../images/client3.jpg" alt="Aymane Benhima"
                                        class="mb-4 rounded-full w-11 h-11">
                                    <div class="flex flex-col mb-4 ml-8">
                    ...
                    <div class="client">
                        <div
                            ...
                            <div>
                                <div class="flex items-center ">
                                    <img src="../images/client4.jpg" alt="Aymane Benhima"
                                        class="mb-4 rounded-full w-11 h-11">
                                    <div class="flex flex-col mb-4 ml-8">
            ...
            <div class="mt-8 flex justify-center gap-4 lg:hidden">
                ...
                <button aria-label="Next slide" id="mobile-next"
                    class="rounded-full border border-black p-3 text-black transition dark:border-white dark:text-white hover:bg-[#00373E] hover:text-white">
                    <svg class="h-5 w-5 rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
